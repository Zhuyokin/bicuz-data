<template>
  <div class="page-wrap">
    ...
    <div v-if="rankingList.length" class="rank-list">
      <div v-for="(item, index) in rankingList" :key="item.id" class="rank-item" :class="{ 'top-rank-wrap': item.ranking === 1 }">
        <template v-if="item.ranking === 1">
          ...
          <div class="rank-footer-wrap">
            <div class="rank-nickname van-ellipsis">
              {{ item.user_nickname }}
            </div>
    ...
    <div class="my-rank-wrap">
      <div class="rank-item van-safe-area-bottom">
        ...
        <div class="rank-info-wrap">
          ...
          <div class="van-ellipsis">
            {{ info.ranking > 1 ? info.live_user_nickname : info.desc }}
          </div>
        </div>
        <div class="rank-score-wrap">
          <div class="rank-score">
